...
Project được thiết kế cho workload quy mô nhỏ trong giai đoạn thực tập, nên phần lớn usage dự kiến nằm trong mức chi phí thấp hoặc free tier. Ước tính cuối cùng nên được tính lại bằng [AWS Pricing Calculator](https://calculator.aws/) trước khi triển khai vì chi phí AWS phụ thuộc vào Region, traffic và plan được chọn.
